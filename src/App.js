...
<div className="list_team" style = {{backgroundColor: theme.list, color: theme.links}}> <img src={require('./avatar/darkhan.svg').default} /><br /><br /><h3>Darkhan Baibulat</h3><p ><b>Front-end Developer</b></p><p className="font1" >Astana IT University</p></div></div>
<div className="grid_team_2">
<div className="list_team2" style = {{backgroundColor: theme.list, color: theme.links}}> <img src={require('./avatar/olzhas.svg').default} /><br /><br /><h3>Olzhas Abdykalykov </h3><p ><b>Back-end Developer</b></p><p className="font1" >Astana IT University</p></div>
<div className="list_team2" style = {{backgroundColor: theme.list, color: theme.links}}> <img src={require('./avatar/kalbek.svg').default} /><br /><br /><h3>Kalbek Saduakassov</h3><p ><b>Back-end Developer</b></p><p className="font1" >Astana IT University</p></div>
<div className="list_team2" style = {{backgroundColor: theme.list, color: theme.links}}> <img src={require('./avatar/aisha.svg').default} /><br /><br /><h3>Aisha Kozhamseitova</h3><p > <b>Mobile Developer</b></p><p className="font1" >Astana IT University</p></div>
