...
function Landing() {
  ...
  return (
    ...
    <div className="foot1"><img src={require('./imgphoto/rectangle.png')} /><img src={require('./imgphoto/Rectangle1.png')} className="ph1" style = {{filter: theme.imgconf1}} /><br />anetaBTC is a decentralized, secure protocol that allows users to unlock the value of their Bitcoin on Ergo and Cardano.</div>
    ...
    <a href="http://discord.gg/anetabtc" class="active" style = {{filter: theme.imgconf1}}><img src={require('./icons/discord.svg').default} /></a>
    <a href="https://twitter.com/anetaBTC" class="active" style = {{filter: theme.imgconf1}}><img src={require('./icons/twitter.svg').default} /></a>
    <a href="https://medium.com/@anetaBTC" class="active" style = {{filter: theme.imgconf1}}><img src={require('./icons/medium.svg').default} /></a>
    <a href="https://t.me/anetaBTC" class="active" style = {{filter: theme.imgconf1}}><img src={require('./icons/telegram.svg').default} /></a>
    </div>
